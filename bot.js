...
var hastagSearch = { q: '#lilpump', count: 10, result_type: 'recent' }
...
function followed (event) {
  ...
  var response = '80 ON MA WRIS WAAA HUP'+ name + ' @' + screenName + ' #ESKETIT' // Post that tweet! 
...
function tweetEvent (tweet) {
  ...
  if (reply_to === 'selftwitterhandle') {
    ...
    var reply = 'wahup @' + name + ' ' + ', #ESKETIT WAAAA GUCCI GANG D ROSE'
